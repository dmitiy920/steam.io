	...
	CapsuleSettingsMenu: function( elSource )
	{
		...
		if( strAppIDs )
		{
			...
			if (!bOnWishlist)
			{
				...
				var strText = "\u0414\u043e\u0431\u0430\u0432\u0438\u0442\u044c \u0432 \u0436\u0435\u043b\u0430\u0435\u043c\u043e\u0435";
			...
			var $elPreferences = $J ( '<a/>' ).attr('href', 'https://store.steampowered.com/account/preferences' ).text ( "\u041d\u0430\u0441\u0442\u0440\u043e\u0439\u043a\u0438" ).addClass( 'option' );
...
function UpdateStoreBannerForAdditionalCartDiscount( nCartDiscount )
{
	...
	<div class="placeHolder_lunarSale2019_giftActiveBar">	\
		...
		<div class="lunar_sale_title"><img src="https://steamstore-a.akamaihd.net/public/images/promo/lunar2019/lny2019_title_ru.png"/></div> \
