...
function CLoginPromptManager( strBaseURL, rgOptions )
{
	...
	if ( typeof BigNumber == 'undefined' )
		$J.ajax( { url: 'https://steamstore-a.akamaihd.net/public/shared/javascript/crypto/jsbn.js', type: 'get', dataType: 'script', cache: true } );
	if ( typeof RSA == 'undefined' )
		$J.ajax( { url: 'https://steamstore-a.akamaihd.net/public/shared/javascript/crypto/rsa.js', type: 'get', dataType: 'script', cache: true } );
}
